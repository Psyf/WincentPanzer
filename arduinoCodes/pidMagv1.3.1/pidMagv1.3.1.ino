...
{
  mag.initialize();
  //left(360, 100);   //SHOULD WE PUT THIS SOMEWHERE ELSE?  
...
void loop() {
 ...
 // put your main code here, to run repeatedly:
  ...
  //NOTE: sCan we put the counter cleanup in stop()?
 ...
 */
  ...
  if (mag.isCalibrated())
  {
    ...
    message[2] = '\0'; 
    sendMessage(message); 
    //problem: readHeading gives wrong stuff; 
    //gives us wrong bearing from homemade formula
  ...
  {  inCommand = 1; 
      if (dir ==FORWARD)
      {
          ...
          if (forwardDist < newDist) forward((int)(newDist-forwardDist), 100);
