...
volatile unsigned long leftBackwardTicks=0; 
volatile unsigned long rightBackwardTicks=0; 
...
volatile unsigned long leftBackwardTicksTurns=0;
volatile unsigned long rightBackwardTicksTurns=0; 
...
volatile unsigned long backwardDist=0;
...
void forward(float dist, float speed)
{
  ...
  newDist = forwardDist + (deltaDist = (unsigned long) dist); 
...
//  if (dist == 0) deltaDist = 9999999; 
  ...
  newDist = backwardDist + (deltaDist = (unsigned long)dist); 
...
void left(float ang, float speed)
{
  ...
  targetTicks = leftBackwardTicksTurns + (deltaTicks = computeDeltaTicks(ang)); 
...
void right(float ang, float speed)
{
  ...
  targetTicks = rightBackwardTicksTurns + (deltaTicks = computeDeltaTicks(ang)); 
